...
const breakpoints = {
  ...
  sm: 576,    // ≥ 576px   (手机横屏)
  md: 768,    // ≥ 768px   (平板竖屏)
  lg: 992,    // ≥ 992px   (平板横屏/小屏笔记本)
  xl: 1200,   // ≥ 1200px  (桌面显示器)
  xxl: 1600   // ≥ 1600px  (大屏显示器)
};
```
...
|---------|---------|-------------|---------|
| **手机** | xs (< 576px) | 单列布局 | 抽屉导航 |
| **手机横屏** | sm (576-768px) | 单列/双列混合 | 抽屉导航 |
| **平板** | md (768-992px) | 双列布局 | 侧边栏可折叠 |
| **小屏笔记本** | lg (992-1200px) | 双列/三列布局 | 固定侧边栏 |
| **桌面** | xl (≥ 1200px) | 三列布局 | 固定侧边栏 |
